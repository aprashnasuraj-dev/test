...
/**
 * Brand marks for the curated wallets in the connect modal. We bundle these
 * (rather than relying on each connector's `.icon`) so the three primary
 * options render with consistent official branding regardless of whether the
 * wallet is installed or what icon its provider happens to announce.
 */

export const MetaMaskIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg aria-hidden="true" fill="none" viewBox="0 0 32 32" {...props}>
    <rect fill="#FFF5EE" height="32" rx="4" width="32" />
    <svg
      aria-hidden="true"
      height="24"
...
export const CoinbaseIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg aria-hidden="true" fill="none" viewBox="0 0 32 32" {...props}>
    <rect fill="#0052FF" height="32" rx="4" width="32" />
    <circle cx="16" cy="16" fill="#fff" r="9.5" />
    <rect fill="#0052FF" height="7.2" rx="1.3" width="7.2" x="12.4" y="12.4" />
  </svg>
)

export const WalletConnectIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg aria-hidden="true" fill="none" viewBox="0 0 32 32" {...props}>
    <rect fill="#3396FF" height="32" rx="4" width="32" />
    <path
